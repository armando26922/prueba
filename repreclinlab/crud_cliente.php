...
<div class="btn-group" role="group">
 ...
 <div aria-hidden="true" aria-labelledby="myModalLabel" role="dialog" tabindex="-1" id="Modal_modificar" class="modal fade">
                      <div class="modal-dialog">
                          <div class="modal-content">
                              ...
                              <div class="modal-body">
                                  ...
                                  <input type="text" id="nombre_cliente_modificar" name="nombre_cliente" placeholder="*usuario" autocomplete="off" class="form-control placeholder-no-fix">                        
                                   <p><strong>RIF</strong></p>
                                  <input  id="RIF_cliente_modificar"  type="text" name="RIF_cliente" placeholder="*usuario" autocomplete="off" class="form-control placeholder-no-fix"> 
              ...
              ?>
                                  ...
                                  <button id="boton_cambio" data-dismiss="modal" class="btn btn-success" type="summit"><strong>Modificar Cliente</strong></button>
