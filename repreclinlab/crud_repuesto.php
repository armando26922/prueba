 ...
 <?php 
                    ...
                    $base_db->ejecutar($sql);
                      ...
                      while($valor=$base_db->obtener_fila($base_db->getCorrida(),0)) { 
                       ...
                       print("<td>".$valor['nivel_minimo_repuesto']."</td>");      
                          ...
                          <div class="modal-content">
                              ...
                              <div class="modal-body">
                                  ...
                                  <input id="nombre_repuesto_agregar" type="text" name="nombre_accion" placeholder="*nombre" autocomplete="off" class="form-control placeholder-no-fix">                        
                                    ...
                                    <p>Ubicacion</p>
                                  <input id="ubicacio" type="text" name="nombre_accion" placeholder="*ubicacion" autocomplete="off" class="form-control placeholder-no-fix">                        

                                   <p>Equipo</p>
                                    <select class="default"  tabindex="2">
                                        <?php 
